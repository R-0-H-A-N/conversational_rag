...
# Title of Webpage
st.title("SYLABOT") # Change this

# Captioning Page : Disclaimer
st.caption("Please be aware that the following content has been generated by an AI system and may contain errors, inconsistencies, or outdated information. It is provided as-is without any warranties or guarantees of accuracy. We strongly recommend using this content as a starting point for further research and consultation with the discipline coordinator")
